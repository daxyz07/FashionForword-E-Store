...
const WomenProducts = () => {
  ...
  const fetchProducts = async () => {
    try {
      const response = await api.getAdminProducts('women');
  ...
  return (
    <div className="product-listing-page">
      ...
      <div className="page-header">
        <h1>Women<span className="colored-word">'s Fashion</span></h1>
        <p className="page-subtitle">Discover elegant and trendy women's clothing</p>
