...
const KidsProducts = () => {
  ...
  const fetchProducts = async () => {
    try {
      const response = await api.getAdminProducts('kids');
  ...
  return (
    <div className="product-listing-page">
      ...
      <div className="page-header">
        <h1>Kids<span className="colored-word">'s Fashion</span></h1>
        <p className="page-subtitle">Fun and colorful clothing for kids</p>
